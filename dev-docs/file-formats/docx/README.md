...
DOCX is signed off for the current input/container conversion scope as of
2026-06-02.
...
remain outside this format sign-off row. Future real-corpus DOCX defects should
