...
- Turn the `test_harness` cluster in [legacy-test-migration-manifest-2026-03-16.csv](legacy-test-migration-manifest-2026-03-16.csv) into concrete keep/rewrite/retire decisions.
...
Legacy source:
- `upstream/src/LiuXin_tests/test_self/folder_stores/test_fsm_loader.py`
...
- [test_resources_manager_assets_test.py](../tests/support/test_resources_manager_assets_test.py)
...
Legacy source:
- `upstream/src/LiuXin_tests/test_self/folder_stores/test_fsms.py`
...
Legacy source:
- `upstream/src/LiuXin_tests/test_self/test_make_test_databases.py`
...
Legacy source:
- `upstream/src/LiuXin_tests/test_self/test_test_objects.py`
...
Legacy source:
- `upstream/src/LiuXin_tests/test_utils/test_processing_tools.py`
...
Legacy source:
- `upstream/src/LiuXin_tests/test_utils/test_utils.py`
...
Current alpha seams:
- [tools.py](../tests/support/test_databases/_legacy/tools.py)
- [objects.py](../tests/support/test_databases/_legacy/objects.py)
...
- Direct collected tree-generator coverage landed in:
  - [test_tree_generators.py](../tests/support/test_databases/test_tree_generators.py)
  - shared helper extraction:
    - [\_tree_generators.py](../tests/support/test_databases/_tree_generators.py)
- `TestObjectsHandler` smoke coverage landed in:
  - [test_legacy_objects_smoke.py](../tests/support/test_databases/test_legacy_objects_smoke.py)
