...
- Added [liuxin_tqdm.py](/home/blackjane/LiuXin-alpha-wsl/src/LiuXin_alpha/utils/libraries/liuxin_tqdm.py)
  - exports:
    - `tqdm`
    - `trange`
  - behavior:
...
- full `py_compile` over [tests/support/test_databases](/home/blackjane/LiuXin-alpha-wsl/tests/support/test_databases) still passes
...
- Example:
  - importing [test_db_4](/home/blackjane/LiuXin-alpha-wsl/tests/support/test_databases/test_db_4/__init__.py) now fails on:
