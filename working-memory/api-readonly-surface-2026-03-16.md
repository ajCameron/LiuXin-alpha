# API Read-Only Surface

Date: 2026-03-16

## Summary

Added a new top-level machine-facing surface package, `surfaces/api_readonly`, as the first standalone read-only JSON API surface.
...
- `PYTHONPATH=src python3 -m LiuXin_alpha.surfaces.api_readonly --database /path/to/library.sqlite`
...
- `PYTHONPATH=src .venv/bin/python -m pytest -q tests/surfaces/test_api_readonly.py`
  - `2 passed`
- `PYTHONPATH=src .venv/bin/python -m pytest -q tests/surfaces/test_api_readonly.py tests/surfaces/test_catalog_api.py tests/surfaces/test_acquisition_api.py tests/surfaces/test_opds_api.py tests/surfaces/test_opds_readonly.py tests/surfaces/test_web_calibre_readonly.py tests/surfaces/test_web_readonly.py`
  - `34 passed`
- `PYTHONPATH=src .venv/bin/python -m py_compile src/LiuXin_alpha/surfaces/api_readonly/app.py src/LiuXin_alpha/surfaces/api_readonly/__init__.py src/LiuXin_alpha/surfaces/api_readonly/__main__.py tests/surfaces/test_api_readonly.py scripts/run_api_readonly.py`
  - passed
