...
- This checklist covers the `salvage_existing` bucket from [legacy-test-migration-manifest-2026-03-16.csv](/mnt/c/Users/Thane-Winterscale/LiuXin-alpha-mainline/working-memory/legacy-test-migration-manifest-2026-03-16.csv).
...
- Treat [tests/support/test_databases](/home/blackjane/LiuXin-alpha-wsl/tests/support/test_databases) as authoritative.
...
- [src/LiuXin_tests/test_databases/test_db_properties/test_db_0_properties.py](/home/blackjane/LiuXin-alpha-wsl/src/LiuXin_tests/test_databases/test_db_properties/test_db_0_properties.py) still imports `SQLite_apsw`
- [tests/support/test_databases/test_db_properties/test_db_0_properties.py](/home/blackjane/LiuXin-alpha-wsl/tests/support/test_databases/test_db_properties/test_db_0_properties.py) imports `SQLite`

That is exactly the kind of drift this normalization pass needs to preserve intentionally, not erase by accident.

Review outcome:
- [src/LiuXin_tests/test_databases/__init__.py](/home/blackjane/LiuXin-alpha-wsl/src/LiuXin_tests/test_databases/__init__.py) and [tests/support/test_databases/__init__.py](/home/blackjane/LiuXin-alpha-wsl/tests/support/test_databases/__init__.py) are now identical again.
...
3. Rewire imports inside [tests/support/test_databases](/home/blackjane/LiuXin-alpha-wsl/tests/support/test_databases) so they stop importing from `LiuXin_tests...`.
...
- the legacy `tqdm` dependency is now routed through:
  - [liuxin_tqdm.py](/home/blackjane/LiuXin-alpha-wsl/src/LiuXin_alpha/utils/libraries/liuxin_tqdm.py)
...
- detailed current state:
  ...
  - [liuxin-clint-shim-2026-03-16.md](/mnt/c/Users/Thane-Winterscale/LiuXin-alpha-mainline/working-memory/liuxin-clint-shim-2026-03-16.md)
  - [liuxin-tqdm-shim-2026-03-16.md](/mnt/c/Users/Thane-Winterscale/LiuXin-alpha-mainline/working-memory/liuxin-tqdm-shim-2026-03-16.md)
...
- shared alpha-schema subset declared in [common_db_properties.py](/home/blackjane/LiuXin-alpha-wsl/tests/support/test_databases/test_db_properties/common_db_properties.py)
- per-DB alpha row counts are now declared for all `26` support classes
- collected validation lives in [test_property_alpha_schema_subset.py](/home/blackjane/LiuXin-alpha-wsl/tests/support/test_databases/test_db_properties/test_property_alpha_schema_subset.py)
