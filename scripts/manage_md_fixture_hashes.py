#!/usr/bin/env python3
"""
Manage metadata-fixture hashes for the optional `LiuXin_alpha_data` corpus.

This script operates on:
  - corpus dir:   LiuXin_alpha_data/md_test_books (or md_test_files)
  - manifest:     tests/support/md_test_fixture_hashes.py

Typical usage:
  - Revalidate current baseline:
      python scripts/manage_md_fixture_hashes.py --revalidate

  - Add/update one newly-added fixture:
      python scripts/manage_md_fixture_hashes.py --add my_new_book_md_test_file_1.epub

  - Do both:
      python scripts/manage_md_fixture_hashes.py --add x.pdb --revalidate
"""
