...
class TestDB18Properties(CommonDBProperties):
    ...
    theo_stable_loc_shelf_numbers_columns = [
        "loc_shelf_number_id",
        "loc_shelf_number",
    ]
    ...
    theo_titles_table_hash = "3310be59ceba8e2e7694c1b6ae9944bf"
    ...
    theo_title_1_loc_shelf_number_rows = theo_title_lsn_count_dict[1]
    theo_title_10_loc_shelf_number_rows = theo_title_lsn_count_dict[10]
