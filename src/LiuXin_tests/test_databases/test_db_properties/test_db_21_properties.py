...
class TestDB21Properties(CommonDBProperties):
    ...
    # ------------------------------------------------------------------------------------------------------------------
    #
    # - NEW MAIN TABLE PROPERTIES

    theo_character_introductions_columns = [
    ...
    theo_stable_character_introductions_columns = [
        "character_introduction_id",
        "character_introduction",
    ]
    ...
    theo_character_introductions = 14

    ci_row_1_val = "character_introductions - 2fa7997a-9998-47fa-85ec-3c81f6180a8b - LINKED TO titles 1 - ROW 0"
    ci_row_10_val = "character_introductions - fe83a7fb-ac72-4c43-a868-869155fee1a1 - LINKED TO titles 6 - ROW 1"
    ...
    # NOT SERIES{1: 96, 2: 96, 3: 96, 4: 96, 5: 96, 6: 96, 7: 96, 8: 96, 9: 96, 10: 96}
    theo_not_series_title_link_count = 251

    theo_not_series_1_val = "not_series - ROW 1 - 02c1e800-e4b1-41ea-9c03-9f1e945725f3"

    theo_not_series_title_link_columns = sorted(
        [
            "not_series_title_link_title_id",
            "not_series_title_link_scratch",
            "not_series_title_link_priority",
