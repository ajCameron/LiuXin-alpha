...
class TestDB23Properties(TestDB22Properties):
    ...
    theo_cc_2_book_col_map = {1: 7, 4: 9, 5: 9, 7: 4, 8: 8, 9: 4, 10: 2}
    theo_cc_2_values = {
        1: "cc2_rating_1",
        2: "cc2_rating_2",
        3: "cc2_rating_3",
    ...
    theo_book_1_cc_2_id = 7
    theo_book_1_cc_2_value = "cc2_rating_7"

    theo_cc4_id_val_map = {
        1: "test books cc4 2 - 9b9e8537-31cf-4683-af4b-5e2a33b75e8a",
        2: "test books cc4 3 - fd5ae8b5-3833-4466-ac34-2efb7dc13bc4",
        3: "test books cc4 4 - b0cd931d-5325-4331-8d08-c038682eb4c3",
        4: "test books cc4 9 - 56f272d2-bd4e-447d-8a3d-171357a5f6e2",
    }

    theo_cc_4_book_col_map = {9: 4, 2: 1, 3: 2, 4: 3}

    theo_cc4_4_val = "test books cc4 9 - 56f272d2-bd4e-447d-8a3d-171357a5f6e2"
    theo_cc4_5_val = None
