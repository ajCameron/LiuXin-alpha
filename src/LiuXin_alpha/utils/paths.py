...
def ensure_prefs_folder():
    ...
    if not check_for_prefs_folder():
        create_prefs_folder()
        LiuXin_warning_print("No preference folder detected. Re-creating from defaults.")
    else:
        LiuXin_print("Preferences folder found.")
...
def ensure_debug_folder():
    ...
    if not check_for_debug_folder():
        create_debug_folder()
        LiuXin_warning_print("Debug folder not found. Created.")
    else:
...
def ensure_scratch_folder():
    ...
    if not check_for_scratch_folder():
        ...
        LiuXin_warning_print("Scratch folder not found. Created.")
    else:
        LiuXin_print("Scratch folder found.")
...
def ensure_program_folder():
    ...
    if not check_for_program_folder():
        ...
        LiuXin_warning_print("Program folder not found. Created.")
    else:
        LiuXin_print("Program folder found.")
    ...
    for folder in req_folders:
        ...
        if mode is None:
            ...
            if not os.path.exists(rb_folder_path):
                ...
                LiuXin_warning_print(rb_folder_path, " already exists")
