...
from LiuXin_alpha.utils.libraries.liuxin_html5lib.tokenizer import HTMLTokenizer
from LiuXin_alpha.utils.libraries.liuxin_html5lib.constants import tokenTypes


content_type_rgx = re.compile(
    r"""
                               ^
