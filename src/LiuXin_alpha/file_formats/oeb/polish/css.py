...
def remove_unused_css(container, report=None, remove_unused_classes=False):
    ...
    :param container:
    :param report: An optional callable that takes a single argument. It is called with information about the
                   operations being performed.
    :param remove_unused_classes: If True, class attributes in the HTML that do not match any CSS rules are also
                                  removed.
    :param report:
    :param remove_unused_classes:
    :return:
    """
