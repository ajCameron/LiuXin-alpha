...
from LiuXin_alpha.file_formats.odf.namespaces import CONFIGNS
from LiuXin_alpha.file_formats.odf.element import Element

# Autogenerated
def ConfigItem(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CONFIGNS, "config-item"), **args)


def ConfigItemMapEntry(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CONFIGNS, "config-item-map-entry"), **args)


def ConfigItemMapIndexed(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CONFIGNS, "config-item-map-indexed"), **args)


def ConfigItemMapNamed(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CONFIGNS, "config-item-map-named"), **args)


def ConfigItemSet(**args: _typing.Any) -> _typing.Any:
