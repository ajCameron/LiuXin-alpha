...
def FooterDecl(**args: _typing.Any) -> _typing.Any:
...
def HeaderDecl(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(PRESENTATIONNS, "header-decl"), **args)


def HideShape(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(PRESENTATIONNS, "hide-shape"), **args)


def HideText(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(PRESENTATIONNS, "hide-text"), **args)


def Notes(**args: _typing.Any) -> _typing.Any:
...
def Play(**args: _typing.Any) -> _typing.Any:
...
def Show(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(PRESENTATIONNS, "show"), **args)


def ShowShape(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(PRESENTATIONNS, "show-shape"), **args)


def ShowText(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(PRESENTATIONNS, "show-text"), **args)


def Sound(**args: _typing.Any) -> _typing.Any:
