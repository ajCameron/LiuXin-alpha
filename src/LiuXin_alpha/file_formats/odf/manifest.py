...
from LiuXin_alpha.file_formats.odf.namespaces import MANIFESTNS
from LiuXin_alpha.file_formats.odf.element import Element

# Autogenerated
def Manifest(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(MANIFESTNS, "manifest"), **args)


def FileEntry(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(MANIFESTNS, "file-entry"), **args)


def EncryptionData(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(MANIFESTNS, "encryption-data"), **args)


def Algorithm(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(MANIFESTNS, "algorithm"), **args)


def KeyDerivation(**args: _typing.Any) -> _typing.Any:
