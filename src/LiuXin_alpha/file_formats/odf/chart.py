...
from LiuXin_alpha.file_formats.odf.namespaces import CHARTNS
from LiuXin_alpha.file_formats.odf.element import Element


# Autogenerated
def Axis(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "axis"), **args)


def Categories(**args: _typing.Any) -> _typing.Any:
...
def DataPoint(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "data-point"), **args)


def Domain(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "domain"), **args)


def ErrorIndicator(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "error-indicator"), **args)


def Floor(**args: _typing.Any) -> _typing.Any:
...
def Legend(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "legend"), **args)


def MeanValue(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "mean-value"), **args)


def PlotArea(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "plot-area"), **args)


def RegressionCurve(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "regression-curve"), **args)


def Series(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "series"), **args)


def StockGainMarker(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "stock-gain-marker"), **args)


def StockLossMarker(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "stock-loss-marker"), **args)


def StockRangeLine(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "stock-range-line"), **args)


def Subtitle(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(CHARTNS, "subtitle"), **args)


def SymbolImage(**args: _typing.Any) -> _typing.Any:
...
def Wall(**args: _typing.Any) -> _typing.Any:
