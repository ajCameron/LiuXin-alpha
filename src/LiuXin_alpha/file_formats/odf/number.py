...
def NumberStyle(**args: _typing.Any) -> _typing.Any:
    return StyleElement(qname=(NUMBERNS, "number-style"), **args)


def PercentageStyle(**args: _typing.Any) -> _typing.Any:
    return StyleElement(qname=(NUMBERNS, "percentage-style"), **args)


def Quarter(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(NUMBERNS, "quarter"), **args)


def ScientificNumber(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(NUMBERNS, "scientific-number"), **args)


def Seconds(**args: _typing.Any) -> _typing.Any:
...
def TextContent(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(NUMBERNS, "text-content"), **args)


def TextStyle(**args: _typing.Any) -> _typing.Any:
    return StyleElement(qname=(NUMBERNS, "text-style"), **args)


def TimeStyle(**args: _typing.Any) -> _typing.Any:
    return StyleElement(qname=(NUMBERNS, "time-style"), **args)


def WeekOfYear(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(NUMBERNS, "week-of-year"), **args)


def Year(**args: _typing.Any) -> _typing.Any:
