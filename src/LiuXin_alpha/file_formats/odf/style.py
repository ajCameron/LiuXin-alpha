...
def StyleElement(**args: _typing.Any) -> _typing.Any:
    e = Element(**args)
...
# Autogenerated
def BackgroundImage(**args: _typing.Any) -> _typing.Any:
    return Element(qname=(STYLENS, "background-image"), **args)


def ChartProperties(**args: _typing.Any) -> _typing.Any:
