...
class RTFInput(InputFormatPlugin):
    ...
    options = {
        OptionRecommendation(
            ...
            option_help=_("Ignore WMF images instead of replacing them with a placeholder image."),
        ),
    }
    ...
    def generate_xml(self: _typing.Self, stream: _typing.Any) -> _typing.Any:
        ...
        parser = ParseRtf(
            in_file=stream,
            out_file=ofile,
            # Convert symbol fonts to unicode equivalents. Default is 1
            convert_symbol=1,
    ...
    def replace_wmf(self: _typing.Self, name: _typing.Any) -> _typing.Any:
        ...
        if self.default_img is None:
            self.default_img = calibre_cover(
                ...
                "Use Microsoft Word or OpenOffice to save this RTF file" " as HTML and convert that in calibre.",
                title_size=36,
                author_size=20,
            )
