...
class FB2Output(OutputFormatPlugin):
    ...
    options = {
        OptionRecommendation(
            ...
            option_help=_(
                "Specify the sectionization of elements. "
                'A value of "nothing" turns the book into a single section. '
                'A value of "files" turns each file into a separate section; use this'
                " if your device is having trouble. "
                'A value of "Table of Contents" turns the entries in the '
                "Table of Contents into titles and creates sections; "
                'if it fails, adjust the "Structure Detection" and/or '
        ...
        OptionRecommendation(
            ...
            level=OptionRecommendation.LOW,
            choices=FB2_GENRES,
            option_help=(_("Genre for the book. Choices: %s\n\n See: ") % ", ".join(FB2_GENRES))
