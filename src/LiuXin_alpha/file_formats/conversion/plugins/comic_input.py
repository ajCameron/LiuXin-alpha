...
class ComicInput(InputFormatPlugin):
    ...
    options = {
        OptionRecommendation(
            ...
            option_help=_(
                "Number of colors for grayscale image conversion. Default: "
        ...
        OptionRecommendation(
            ...
            option_help=_("Disable normalize (improve contrast) color range " "for pictures. Default: False"),
        ),
        OptionRecommendation(
            name="keep_aspect_ratio",
            recommended_value=False,
            option_help=_("Maintain picture aspect ratio. Default is to fill the screen."),
        ),
        OptionRecommendation(name="dont_sharpen", recommended_value=False, option_help=_("Disable sharpening.")),
        OptionRecommendation(
            name="disable_trim",
            recommended_value=False,
            option_help=_(
        ...
        OptionRecommendation(
            name="landscape",
            recommended_value=False,
            option_help=_("Don't split landscape images into two portrait images"),
        ),
        OptionRecommendation(
            name="wide",
            recommended_value=False,
        ...
        OptionRecommendation(
            ...
            recommended_value=False,
            option_help=_(
                "Used for right-to-left publications like manga. "
        ...
        OptionRecommendation(
            name="despeckle",
            recommended_value=False,
            option_help=_("Enable Despeckle. Reduces speckle noise. " "May greatly increase processing time."),
        ),
        OptionRecommendation(
            name="no_sort",
            recommended_value=False,
        ...
        OptionRecommendation(
            ...
            option_help=_(
                "The format that images in the created ebook "
        ...
        OptionRecommendation(
            name="no_process",
            recommended_value=False,
            option_help=_("Apply no processing to the image"),
        ),
        OptionRecommendation(
            name="dont_grayscale",
            recommended_value=False,
            option_help=_("Do not convert the image to grayscale (black and white)"),
        ),
        OptionRecommendation(
