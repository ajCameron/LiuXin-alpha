...
class EPUBOutput(OutputFormatPlugin):
    ...
    options = {
        ...
        OptionRecommendation(
            ...
            recommended_value=False,
            option_help=_("Insert an inline Table of Contents that will appear as part " "of the main book content."),
        ),
        OptionRecommendation(
            name="epub_toc_at_end",
            recommended_value=False,
            option_help=_("Put the inserted inline Table of Contents at the end of the book " "instead of the start."),
        ),
        OptionRecommendation(
            name="toc_title",
            recommended_value=None,
            option_help=_("Title for any generated in-line table of contents."),
        ),
    }
    ...
    def convert(self, oeb_book, output_path, input_plugin, opts, log):
        ...
        if uuid is None:
            ...
            uuid = str(uuid4())
            oeb_book.metadata.add("identifier", uuid, scheme="uuid", id=uuid)
            ...
            if hasattr(body, "xpath"):
                ...
                for br in XPath("./h:br")(body):
                    ...
                    try:
                        ...
                        info_message = "Error while producing epub file."
                        default_log.log(info_message, e, "INFO")
                        priortag = "body"
                        priortext = body.text
                    if priortext:
                    ...
                    style = filter(None, map(lambda local_x: local_x.strip(), style))
