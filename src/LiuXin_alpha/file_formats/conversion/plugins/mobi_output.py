...
class MOBIOutput(OutputFormatPlugin):
    ...
    options = {
        OptionRecommendation(
            ...
            option_help=_("When present, use author sort field as author."),
        ),
        OptionRecommendation(
            name="no_inline_toc",
            recommended_value=False,
        ...
        OptionRecommendation(
            ...
            recommended_value=False,
            level=OptionRecommendation.LOW,
            option_help=_("Disable compression of the file contents."),
        ),
        OptionRecommendation(
            name="personal_doc",
        ...
        OptionRecommendation(
            ...
            recommended_value=None,
            option_help=_(
                "Extract the contents of the MOBI file to the"
    ...
    def check_for_masthead(self):
        ...
        if not found:
            ...
            masthead_id, href = self.oeb.manifest.generate("masthead", "masthead")
            self.oeb.manifest.add(masthead_id, href, "image/gif", data=raw)
    ...
    def convert(self, oeb_book, output_path, input_plugin, opts, log):
        ...
        resources = Resources(oeb_book, opts, self.is_periodical, add_fonts=create_kf8)
