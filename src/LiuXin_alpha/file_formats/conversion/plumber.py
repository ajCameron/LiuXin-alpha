...
class Plumber(object):
    ...
    def __init__(
        ...
        self.pipeline_options = [
            ...
            OptionRecommendation(
                ...
                option_help=_(
                    ...
                    "an output profile can be used to optimize the output for a particular device, "
            ...
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                option_help=_("Disable all rescaling of font sizes."),
            ),
            OptionRecommendation(
            ...
            OptionRecommendation(
                ...
                option_help=_(
                    ...
                    "EPUB, AZW3 or PDF. Please ensure that you have the proper license for "
            ...
            OptionRecommendation(
                ...
                recommended_value=False,
                level=OptionRecommendation.LOW,
                option_help=_("Don't add auto-detected chapters to the Table of " "Contents."),
            ),
            OptionRecommendation(
                name="toc_threshold",
                recommended_value=6,
            ...
            OptionRecommendation(
                ...
                r"re:test(., '\s*((chapter|book|section|part)\s+)|"
                r"((prolog|prologue|epilogue)(\s+|$))', 'i')) or @class "
                "= 'chapter']",
                level=OptionRecommendation.LOW,
                option_help=_(
                    "An XPath expression to detect chapter titles. The default "
                    "is to consider <h1> or <h2> tags that contain the words "
                    '"chapter","book","section", "prologue", "epilogue", or "part" '
                    "as chapter titles as "
            ...
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                option_help=_(
                    "An XPath expression. Page breaks are inserted "
            ...
            OptionRecommendation(
                ...
                recommended_value=False,
                level=OptionRecommendation.LOW,
                option_help=_("Use the cover detected from the source file in preference " "to the specified cover."),
            ),
            OptionRecommendation(
            ...
            OptionRecommendation(
                ...
                level=OptionRecommendation.LOW,
                option_help=_(
                    "Remove the first image from the input ebook. Useful if the "
            ...
            OptionRecommendation(
                ...
                recommended_value=False,
                level=OptionRecommendation.LOW,
                option_help=_("Convert fancy quotes, dashes and ellipsis to their " "plain equivalents."),
            ),
            OptionRecommendation(
            ...
            OptionRecommendation(
                ...
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the title."),
            ),
            OptionRecommendation(
                name="authors",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the authors. Multiple authors should be separated by " "ampersands."),
            ),
            OptionRecommendation(
                name="title_sort",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("The version of the title to be used for sorting. "),
            ),
            OptionRecommendation(
                name="author_sort",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("String to be used when sorting by author. "),
            ),
            OptionRecommendation(
                name="cover",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the cover to the specified file or URL"),
            ),
            OptionRecommendation(
                name="comments",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the ebook description."),
            ),
            OptionRecommendation(
                name="publisher",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the ebook publisher."),
            ),
            OptionRecommendation(
                name="series",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the series this ebook belongs to."),
            ),
            OptionRecommendation(
                name="series_index",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the index of the book in this series."),
            ),
            OptionRecommendation(
                name="rating",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the rating. Should be a number between 1 and 5."),
            ),
            OptionRecommendation(
                name="isbn",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the ISBN of the book."),
            ),
            OptionRecommendation(
                name="tags",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the tags for the book. Should be a comma separated list."),
            ),
            OptionRecommendation(
                name="book_producer",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the book producer."),
            ),
            OptionRecommendation(
                name="language",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the language."),
            ),
            OptionRecommendation(
                name="pubdate",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the publication date."),
            ),
            OptionRecommendation(
                name="timestamp",
                recommended_value=None,
                level=OptionRecommendation.LOW,
                option_help=_("Set the book timestamp (no longer used anywhere)"),
            ),
            OptionRecommendation(
            ...
            OptionRecommendation(
                ...
                recommended_value=True,
                level=OptionRecommendation.LOW,
                option_help=_("Look for common words and patterns that denote " "italics and italicize them."),
            ),
            OptionRecommendation(
                name="fix_indents",
                recommended_value=True,
            ...
            OptionRecommendation(
                ...
                recommended_value=True,
                level=OptionRecommendation.LOW,
                option_help=_("Unwrap lines using punctuation and other formatting clues."),
            ),
            OptionRecommendation(
            ...
            OptionRecommendation(
                ...
                recommended_value="",
                level=OptionRecommendation.LOW,
                option_help=_("Search pattern (regular expression) to be replaced with " "sr1-replace."),
            ),
            OptionRecommendation(
                name="sr1_replace",
                recommended_value="",
                level=OptionRecommendation.LOW,
                option_help=_("Replacement to replace the text found with sr1-search."),
            ),
            OptionRecommendation(
                name="sr2_search",
                recommended_value="",
                level=OptionRecommendation.LOW,
                option_help=_("Search pattern (regular expression) to be replaced with " "sr2-replace."),
            ),
            OptionRecommendation(
                name="sr2_replace",
                recommended_value="",
                level=OptionRecommendation.LOW,
                option_help=_("Replacement to replace the text found with sr2-search."),
            ),
            OptionRecommendation(
                name="sr3_search",
                recommended_value="",
                level=OptionRecommendation.LOW,
                option_help=_("Search pattern (regular expression) to be replaced with " "sr3-replace."),
            ),
            OptionRecommendation(
                name="sr3_replace",
                recommended_value="",
                level=OptionRecommendation.LOW,
                option_help=_("Replacement to replace the text found with sr3-search."),
            ),
            OptionRecommendation(
                name="search_replace",
                recommended_value=None,
        ...
        # Build set of all possible options. Two options are equal if their names are the same.
        if not dummy:
            try:
                self.input_options = self.input_plugin.options.union(self.input_plugin.common_options)
            except AttributeError as e:
                err_str = "Problem has arisen while trying to build a set of all possible input options"
                err_str = default_log.log_exception(err_str, e, "ERROR", ("input_fmt", input_fmt))
                raise AttributeError(err_str)
            try:
                self.output_options = self.output_plugin.options.union(self.output_plugin.common_options)
            except AttributeError as e:
                err_str = "Problem has arisen while trying to build a set of all possible output options"
                err_str = default_log.log_exception(err_str, e, "ERROR", ("output_fmt", output_fmt))
                raise AttributeError(err_str)
        else:
            ...
            if val is not None:
                if x == "authors":
                    ...
                    try:
                        ...
                        self.log.warn(
                            _("Values of series index and rating must" " be numbers. Ignoring"),
                            val,
                        )
                        continue
                    ...
                    try:
                        ...
                        self.log.exception(_("Failed to parse date/time") + " " + six_unicode(val))
                        continue
                setattr(mi, x, val)
    ...
    def read_user_metadata(self):
        ...
        if self.opts.read_metadata_from_opf is not None:
            ...
            opf = OPF(
                open(self.opts.read_metadata_from_opf, "rb"),
    ...
    def run(self):
        ...
        if self.opts.debug_pipeline is not None:
            ...
            open(os.path.join(self.opts.debug_pipeline, "README.txt"), "w").write(DEBUG_README.encode("utf-8"))
        ...
        # 2) - Create an OEBBook from the input file. The input plugin does all the heavy lifting.
        accelerators = {}
        ...
        with self.input_plugin:
            ...
            # If the pipeline is running in debug mode save the results of the first stage - converting to OEB
            if self.opts.debug_pipeline is not None:
            ...
            # Some of the input methods seem to return a path to an OPF file - instead of an OEB object
            # This standardizes them - ensures the output is the OEB file class
            ...
            # If the output is being prepared for the regex wizard it only needs to get to the HTML stage - returning
            # at this point
            if self.for_regex_wizard:
                return

            # Run the postprocess plugins - allows modifying the look and feel of a book before it's converted into
            ...
            # Dump the result of running the postprocess plugins to the debug file
            if self.opts.debug_pipeline is not None:
            ...
            # Specialize is an optional method which allows the input plugin to adapt the OEBBook for the specific file
            # type it's being converted to
            self.input_plugin.specialize(self.oeb, self.opts, self.log, self.output_fmt)

        # 3) With the OEB in hand, run transforms to neaten it up before presenting it for output
        pr(0.0, _("Running transforms on ebook..."))
        ...
        if self.output_plugin.file_type != "epub":
            # Remove the toc reference to the html cover, if any, except for epub, as the epub output plugin will do
            # the right thing with it.
            item = getattr(self.oeb.toc, "item_that_refers_to_cover", None)
            if item is not None and item.count() == 0:
                self.oeb.toc.remove(item)

        # CSS stores font sizes as names from xx-small to xx-large, then huge. These need to be remapped to sensible
        # points values so that the CSS can be flattened. This provides a mapping so that this can be done.
        ...
        # Allows for extra CSS to be added to the start of the CSS for the main book
        if self.opts.extra_css and os.path.exists(self.opts.extra_css):
            self.opts.extra_css = open(self.opts.extra_css, "rb").read()

        # Sets the properties of the breaks between paragraphs
        ...
        # Transforms should now have completely run - dump current state
        self.log.info("Creating %s..." % self.output_plugin.name)

        # 4) Hand off to the output plugin
...
# This has to be global as create_oebbook can be called from other locations (for example in the html input plugin)
