...
PLACEHOLDER_GIF = (
    b"GIF89a\x01\x00\x01\x00\xf0\x00\x00\x00\x00\x00\xff\xff\xff!\xf9\x04\x01\x00\x00\x00\x00!\xfe "
    b"calibre-placeholder-gif-for-azw3\x00,\x00\x00\x00\x00\x01\x00\x01\x00\x00\x02\x02D\x01\x00;"
)  # noqa
...
class Resources(object):
    ...
    def add_resources(self, add_fonts):
        ...
        if "masthead" in oeb.guide and oeb.guide["masthead"].href:
            ...
            data = generate_masthead(six_unicode(self.oeb.metadata["title"][0]))
