...
class ManyToOneMetadataContainerAPI(abc.ABC):
    """
    Container representing a many-to-one metadata link.

    Many entries in table A are linked to one row in table B.
    ...
    def __init__(self, db: DatabaseAPI, primary_table: str, secondary_table_row: RowAPI) -> None:
        """
        ...
        self._secondary_table_row = secondary_table_row
