...
This provides a convenient container for the date entries for individual rows.
"""
...
@dataclass(slots=True, kw_only=True)
class ExpressionDatesContainer(
    BaseTargetDatesContainer[ExpressionDate, ExpressionKindDatesContainer]):
    """
    Dates container for the dates in an expression row.
    """
    expression_id: ExpressionID
...
@dataclass(slots=True, kw_only=True)
class ManifestationDatesContainer(
    BaseTargetDatesContainer[ManifestationDate, ManifestationKindDatesContainer]):
    """
    Dates container for the dates in a manifestation row.
    """
    manifestation_id: ManifestationID
