...
_target_module = importlib.import_module("LiuXin_alpha.metadata.api.metadata_container_api.wemi_containers_api.metadata_additional_containers_api.series_containers")
