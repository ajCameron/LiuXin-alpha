...
from LiuXin_alpha.databases.caches.calibre.tables.many_one_tables.priority_many_to_one_table import (
...
from LiuXin_alpha.databases.caches.calibre.tables.many_one_tables.specific_many_to_one_tables import (
    CalibreRatingTable,
