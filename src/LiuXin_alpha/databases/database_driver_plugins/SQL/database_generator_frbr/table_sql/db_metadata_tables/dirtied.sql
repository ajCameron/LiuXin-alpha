...
CREATE TABLE IF NOT EXISTS `metadata_dirtied_books` (
  ...
  metadata_dirtied_timestamp DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  metadata_dirtied_timestamp_ep_k INTEGER NOT NULL DEFAULT (CAST((julianday('now') - 2440587.5) * 86400000 AS INTEGER)),
