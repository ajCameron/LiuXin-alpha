...
CREATE TABLE IF NOT EXISTS `metadata_dirtied_books` (
  ...
  `metadata_dirtied_book_datestamp` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `metadata_dirtied_book_scratch` TEXT NULL,
...
CREATE TABLE IF NOT EXISTS `hashes` (
  ...
  `hash_datestamp` DATETIME DEFAULT CURRENT_TIMESTAMP,
