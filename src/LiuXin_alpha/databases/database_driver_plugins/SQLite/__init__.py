...
def get_SQLite_driver_master_version():
    import LiuXin.databases.database as lx_database

    database_version = lx_database.__object_version__

    import LiuXin.databases.metadata_tools as lx_md_tools

    md_tools_version = lx_md_tools.__md_tools_version__

    import LiuXin.metadata.constants as md_constants

    md_constants_version = md_constants.__md_version__

    import LiuXin.constants as lx_constants
