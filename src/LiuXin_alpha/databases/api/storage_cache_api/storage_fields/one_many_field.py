...
if TYPE_CHECKING:
    ...
    from LiuXin_alpha.databases.api.storage_cache_api.storage_tables.link_tables.one_many_tables import StorageCacheOneToManyLinkTableBaseAPI
    from LiuXin_alpha.databases.api.storage_cache_api.storage_tables.link_tables.one_many_tables import StorageCacheOneToManyLinkTableAPI
    ...
    from LiuXin_alpha.databases.api.storage_cache_api.storage_tables.link_tables.one_many_tables import OneManyInterlinkTableUpdate
...
class OneToManyFieldAPI(FieldBasicInterfaceAPI):
    ...
    link_table: "StorageCacheOneToManyLinkTableAPI"
    ...
    def get_link_table(
        ...
        src_table: Union["StorageStorageCacheSingleTableAPI", MainTableName],
        dst_table: Union["StorageStorageCacheSingleTableAPI", MainTableName]
    ) -> "StorageCacheOneToManyLinkTableAPI":
        """
