...
class StorageCacheManyToOneLinkTableAPI(StorageCacheLinkTableBaseAPI):
    """
...
class StorageCacheManyToOneTypedLinkTableAPI(StorageCacheLinkTableBaseAPI):
    """
...
class StorageCacheManyToOnePriorityLinkTableAPI(StorageCacheLinkTableBaseAPI):
    """
    Represents data that can have many values, stored in another table, with a type.
...
class StorageCacheManyToOnePriorityTypedLinkTableAPI(StorageCacheLinkTableBaseAPI):
    """
    Represents data that can have many values, stored in another table, with a type.
