...
class StorageCacheOneToManyLinkTableAPI(StorageCacheLinkTableBaseAPI):
    """
...
class StorageCacheOneToManyLinkTableAPI(StorageCacheOneToManyLinkTableBaseAPI):
    """
...
class StorageCacheOneToManyTypedLinkTableAPI(StorageCacheOneToManyLinkTableBaseAPI):
    """
...
class StorageCacheOneToManyPriorityLinkTableAPI(StorageCacheOneToManyLinkTableBaseAPI):
    """
...
class StorageCacheOneToManyPriorityTypedLinkTableAPI(StorageCacheOneToManyLinkTableBaseAPI):
    """
    Represents data that can have many values, stored in another table, with a priority.
