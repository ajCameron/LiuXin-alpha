...
from LiuXin.constants import islinux
...
from LiuXin.devices.usbms.device import USBDevice
from LiuXin.devices.usbms.driver import USBMS, debug_print

from LiuXin.metadata import authors_to_sort_string, authors_to_string
...
class PRST1(USBMS):
    ...
    def books(self, oncard=None, end_session=True):
        ...
        with closing(sqlite.connect(dbpath)) as connection:
            ...
            connection.text_factory = lambda x: six_unicode(x, "utf-8", "replace")
    ...
    def update_device_books(self, connection, booklist, source_id, plugboard, dbpath):
        # Todo: Go back and make this work
        opts = self.settings()
