...
from LiuXin.constants import isunix

import LiuXin.devices.cybook.t2b as t2b
import LiuXin.devices.cybook.t4b as t4b
...
class ORIZON(CYBOOK):
    ...
    EXTRA_CUSTOMIZATION_MESSAGE = [
        ...
        + _(
            ...
            "memory card. This folder is prepended to any send to device template"
        )
        + "</p>",
    ]
