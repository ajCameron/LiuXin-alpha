...
class Bookmark:  # {{{
    ...
    def record(self, n):
        from LiuXin.utils.calibre.ebooks.metadata.mobi import StreamSlicer
    ...
    def get_bookmark_data(self):
        ...
        if self.bookmark_extension == "mbp":
            ...
            with open(self.path, "rb") as f:
                ...
                while sig == "BKMK":
                    ...
                    if end_loc in user_notes and (
                        user_notes[end_loc]["type"] == "Highlight" or user_notes[end_loc]["type"] == "Note"
                    ):
            ...
            from LiuXin.utils.calibre.ebooks.metadata.topaz import (
                get_metadata as get_topaz_metadata,
            )
    ...
    def get_book_length(self):
        ...
        if self.bookmark_extension == "mbp":
            ...
            from LiuXin.utils.calibre.ebooks.metadata.topaz import MetadataUpdater
            ...
            from LiuXin.utils.calibre import plugins
