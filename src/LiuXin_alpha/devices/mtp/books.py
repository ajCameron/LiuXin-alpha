...
from LiuXin.devices.interface import BookList as BL

from LiuXin.metadata import title_sort
from LiuXin.metadata.book.json_codec import JsonCodec

# Todo: Check that MetaData has all the methods needed
...
class Book(Metadata):
    ...
    def __eq__(self, other):
        return isinstance(other, self.__class__) and (
            self.storage_id == other.storage_id and self.mtp_relpath == other.mtp_relpath
        )
