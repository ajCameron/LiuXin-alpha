...
from LiuXin.devices.errors import PathError
from LiuXin.devices.mtp.base import debug
from LiuXin.devices.mtp.defaults import DeviceDefaults
...
from LiuXin.utils.ptempfiles import SpooledTemporaryFile, PersistentTemporaryDirectory

from LiuXin.utils.lx_libraries.liuxin_six import six_unicode

# Picks up the right version of the driver
BASE = importlib.import_module("LiuXin.devices.mtp.%s.driver" % ("windows" if iswindows else "unix")).MTP_DEVICE
...
class MTP_DEVICE(BASE):
    ...
    def is_folder_ignored(self, storage_or_storage_id, path, ignored_folders=None):
        storage_id = six_unicode(getattr(storage_or_storage_id, "object_id", storage_or_storage_id))
    ...
    def open(self, device, library_uuid):
        from LiuXin.utils.date import isoformat, utcnow
    ...
    def books(self, oncard=None, end_session=True):
        from LiuXin.devices.mtp.books import JSONCodec
        from LiuXin.devices.mtp.books import BookList, Book
    ...
    def upload_books(self, files, names, on_card=None, end_session=True, metadata=None):
        ...
        from LiuXin.utils.calibre.devices.utils import sanity_check
    ...
    def add_books_to_metadata(self, mtp_files, metadata, booklists):
        ...
        from LiuXin.devices.mtp.books import Book
    ...
    def recursive_delete(self, obj):
        ...
        if parent.empty and parent.can_delete and not parent.is_system:
            try:
                ...
                prints("Failed to delete parent: %s, ignoring" % ("/".join(parent.full_path)))
    ...
    def config_widget(self):
        from LiuXin.interfaces.gui2.device_drivers.mtp_config import MTPConfig
