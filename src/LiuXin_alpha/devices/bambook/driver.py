...
from LiuXin.devices.bambook.libbambookcore import (
    Bambook,
    text_encoding,
    CONN_CONNECTED,
    is_bambook_lib_ready,
)
from LiuXin.devices.errors import OpenFeedback
from LiuXin.devices.interface import DevicePlugin
from LiuXin.devices.usbms.books import Book, BookList
...
class BAMBOOK(DeviceConfig, DevicePlugin):
    ...
    EXTRA_CUSTOMIZATION_MESSAGE = _("Device IP Address (restart calibre after changing)")
        ...
        def update_booklist(book, prefix):
            ...
            try:
                ...
                if idx is not None:
                    ...
                    if booklist.add_book(book, replace_metadata=False):
                        changed = True
