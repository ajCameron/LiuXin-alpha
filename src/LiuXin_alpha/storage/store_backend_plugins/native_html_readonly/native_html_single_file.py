"""Read-only single-file wrapper for URLs discovered via the native HTML crawler."""
...
class NativeHtmlReadOnlySingleFile(SingleFileAPI):
    """Represents one discovered URL from a native HTML crawl."""
    ...
    def as_string(self) -> str:
        raise NotImplementedError("native HTML crawler file wrappers do not download payloads.")
