"""
Concrete schema-backed implementation of many-to-many storage fields.
"""
...
class SchemaBackedManyManyField(
    _SchemaBackedRelationFieldBase[Any],
    ManyToManyFieldAPI[Any],
):
    """
    Field wrapper over a many-to-many relation.
    """
...
__all__ = ["SchemaBackedManyManyField"]
